...
const translations = {
    pt: {
        ...
        brinkids: 'Brinkids - Recreio Infantil',
        brinkidsDesc: 'Sistema de recreio infantil em shopping onde os pais deixam as crianças por período determinado com valor tabelado. Inclui sistema de acréscimos por atraso, controle de entrada/saída e verificação de segurança com foto do responsável para retirada das crianças.',
    ...
    en: {
        ...
        brinkids: 'Brinkids - Children\'s Recreation',
        brinkidsDesc: 'Children\'s recreation system in shopping mall where parents leave their children for a determined period with fixed pricing. Includes late fee system, entry/exit control and security verification with responsible person\'s photo for children pickup.',
