...
const translations = {
    pt: {
        ...
        fullName: 'Marcos Paulo Barbosa',
        aboutIntro: 'Desenvolvedor Full Stack apaixonado por criar soluções inovadoras e escaláveis.',
        focusedOnResults: '🎯 Focado em Resultados',
        alwaysLearning: '🚀 Sempre Aprendendo',
        creativeSolutions: '💡 Soluções Criativas',
    ...
    en: {
        ...
        fullName: 'Marcos Paulo Barbosa',
        aboutIntro: 'Passionate Full Stack Developer focused on creating innovative and scalable solutions.',
        focusedOnResults: '🎯 Focused on Results',
